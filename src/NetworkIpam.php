...
class NetworkIpam extends ClassStructure
{
    ...
    /** @var NetworkIpamConfigItems[]|array */
    public $config;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->config = Schema::arr();
        $properties->config->items = NetworkIpamConfigItems::schema();

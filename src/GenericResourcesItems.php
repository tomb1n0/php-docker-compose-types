...
class GenericResourcesItems extends ClassStructure
{
    const X_PROPERTY_PATTERN = '^x-';

    /** @var GenericResourcesItemsDiscreteResourceSpec */
    public $discreteResourceSpec;
    ...
    {
        $properties->discreteResourceSpec = GenericResourcesItemsDiscreteResourceSpec::schema();
        $ownerSchema->addPropertyMapping('discrete_resource_spec', self::names()->discreteResourceSpec);
